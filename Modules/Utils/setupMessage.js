...
module.exports = (settings, ephemeral = false, components = null) => {
  ...
  if (Embeds && Array.isArray(Embeds) && Embeds[0]) {
    for (let index = 0; index < Embeds.length; index++) {
      ...
      let Content =
          settings.content || embedSettings.content || embedSettings.Content,
        ...
        Description =
          ...
          embedSettings.Description,
        Footer =
          settings.footer || embedSettings.footer || embedSettings.Footer,
        FooterAvatarImage =
          settings.footericon ||
        ...
        Thumbnail =
          ...
          embedSettings.Thumbnail,
        Author =
          settings.author || embedSettings.author || embedSettings.Author,
        AuthorAvatarImage =
          settings.authoricon ||
        ...
        Color =
          ...
          "2f3136",
        Fields =
          settings.fields || embedSettings.fields || embedSettings.Fields,
      ...
      if (!Title && !Author && !Description && !Fields) {
        embed
          .setTitle("Error")
          .setDescription("At least 1 value is requried to build a embed");
