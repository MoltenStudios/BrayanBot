            ...
            if (Options && Array.isArray(Options)) {
                ...
                for (let index = 0; index < Options.length; index++) {
                    ...
                    if (option.Type && optionTypes.includes(option.Type.toLowerCase())) {
                        if (!option.Name)
                            Utils.logError(`[Utils] [SlashCommandCreator] A ${chalk.bold("Name")} is required to build Slash Command's option.`)
                        if (!option.Description)
                            Utils.logError(`[Utils] [SlashCommandCreator] A ${chalk.bold("Description")} is required to build Slash Command's option.`)
