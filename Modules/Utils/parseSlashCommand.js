          ...
          if (option.Type && optionTypes.includes(option.Type.toLowerCase())) {
            ...
            if (option.Name && option.Description) {
              let optionData = {
                ...
                channel_types:
                  option.ChannelTypes && Array.isArray(option.ChannelTypes)
                    ? []
                    : null,
                choices: [],
              };
              ...
              if (option.Type) {
                if (["string", 3].includes(option.Type.toLowerCase())) {
                  optionData.type = 3;
                  ...
                  ["mentionable", 9].includes(option.Type.toLowerCase())
                ) {
                  optionData.type = 9;
                } else {
                  Utils.logError(
              ...
              if (
                ...
                ["string", 3, "integer", 4, "number", 10].includes(
              ...
              if (
                ...
                ["channel", 7].includes(option.Type.toLowerCase())
              ) {
                option.ChannelTypes.forEach((channelType) => {
                  if (channelTypes.includes(channelType.toLowerCase())) {
                    if (
                      ...
                      ["guild_voice", 2, "voice"].includes(
                        channelType.toLowerCase()
                      )
                    ) {
                      optionData.channel_types.push(2);
                    } else if (
                      ["guild_category", 4, "category"].includes(
                        channelType.toLowerCase()
                      )
                    ) {
                      ...
                      ["guild_store", 6, "store", "store_thread"].includes(
                        channelType.toLowerCase()
                      )
                    ) {
                      ...
                      [
                        ...
                        "news thread",
                        "news_thread",
                      ].includes(channelType.toLowerCase())
                    ) {
