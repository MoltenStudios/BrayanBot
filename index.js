...
installModules().then(() => {
    ...
    if (process.versions.node < 16.6)
        return require("./Modules/Utils").logError(`BrayanBot Requires Node.js version 16.6.0 or Higher.`);
    ...
    [
        "ErrorHandler.js", "EventHandler.js", "CommandHandler.js", "AddonHandler.js",
